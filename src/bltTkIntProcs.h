...
#endif
#ifndef Blt_GetNameUid_DECLARED
#define Blt_GetNameUid_DECLARED
/* 14 */
BLT_EXTERN Tk_Uid	Blt_GetNameUid(Tk_Window tkwin);
#endif
#ifndef Blt_SetNameUid_DECLARED
#define Blt_SetNameUid_DECLARED
/* 15 */
...
typedef struct BltTkIntProcs {
    ...
    Tk_Uid (*blt_GetNameUid) (Tk_Window tkwin); /* 14 */
    void (*blt_SetNameUid) (Tk_Window tkwin, const char *name); /* 15 */
    Tk_Window (*blt_FindChild) (Tk_Window parent, char *name); /* 16 */
    Tk_Window (*blt_FirstChild) (Tk_Window parent); /* 17 */
    Tk_Window (*blt_NextChild) (Tk_Window tkwin); /* 18 */
    void (*blt_RelinkWindow) (Tk_Window tkwin, Tk_Window newParent, int x, int y); /* 19 */
    Tk_Window (*blt_Toplevel) (Tk_Window tkwin); /* 20 */
    int (*blt_GetPixels) (Tcl_Interp *interp, Tk_Window tkwin, const char *string, int check, int *valuePtr); /* 21 */
    ...
    int (*blt_GetWindowExtents) (Display *display, Window window, int *xPtr, int *yPtr, int *widthPtr, int *heightPtr); /* 42 */
    ...
    Blt_DrawableAttributes * (*blt_GetDrawableAttributes) (Display *display, Drawable drawable); /* 47 */
    void (*blt_SetDrawableAttributes) (Display *display, Drawable drawable, int width, int height, int depth, Colormap colormap, Visual *visual); /* 48 */
    void (*blt_SetDrawableAttributesFromWindow) (Tk_Window tkwin, Drawable drawable); /* 49 */
    void (*blt_FreeDrawableAttributes) (Display *display, Drawable drawable); /* 50 */
    ...
    void (*blt_GetBoundingBox) (double width, double height, double angle, double *widthPtr, double *heightPtr, Point2d *points); /* 56 */
    int (*blt_ParseTifTags) (Tcl_Interp *interp, const char *varName, const unsigned char *bytes, off_t offset, size_t numBytes); /* 57 */
    ...
    Blt_PaintBrush (*blt_NewStripesBrush) (void); /* 68 */
    Blt_PaintBrush (*blt_NewCheckersBrush) (void); /* 69 */
    ...
    const char * (*blt_GetBrushTypeName) (Blt_PaintBrush brush); /* 73 */
    const char * (*blt_GetBrushName) (Blt_PaintBrush brush); /* 74 */
    const char * (*blt_GetBrushColorName) (Blt_PaintBrush brush); /* 75 */
    Blt_Pixel * (*blt_GetBrushPixel) (Blt_PaintBrush brush); /* 76 */
    Blt_PaintBrushType (*blt_GetBrushType) (Blt_PaintBrush brush); /* 77 */
    XColor * (*blt_GetXColorFromBrush) (Tk_Window tkwin, Blt_PaintBrush brush); /* 78 */
    ...
    void (*blt_SetBrushArea) (Blt_PaintBrush brush, int x, int y, int w, int h); /* 91 */
    int (*blt_GetBrushAlpha) (Blt_PaintBrush brush); /* 92 */
    void (*blt_GetBrushOrigin) (Blt_PaintBrush brush, int *xPtr, int *yPtr); /* 93 */
    unsigned int (*blt_GetAssociatedColorFromBrush) (Blt_PaintBrush brush, int x, int y); /* 94 */
    int (*blt_IsVerticalLinearBrush) (Blt_PaintBrush brush); /* 95 */
    int (*blt_IsHorizontalLinearBrush) (Blt_PaintBrush brush); /* 96 */
    void (*blt_PaintRectangle) (Blt_Picture picture, int x, int y, int w, int h, int dx, int dy, Blt_PaintBrush brush, int composite); /* 97 */
    void (*blt_PaintPolygon) (Blt_Picture picture, int n, Point2d *vertices, Blt_PaintBrush brush); /* 98 */
    ...
    ClientData (*blt_Image_GetMasterData) (Tk_Image tkImage); /* 153 */
...
#endif
#ifndef Blt_GetNameUid
#define Blt_GetNameUid \
	(bltTkIntProcsPtr->blt_GetNameUid) /* 14 */
#endif
#ifndef Blt_SetNameUid
#define Blt_SetNameUid \
	(bltTkIntProcsPtr->blt_SetNameUid) /* 15 */
#endif
#ifndef Blt_FindChild
#define Blt_FindChild \
	(bltTkIntProcsPtr->blt_FindChild) /* 16 */
#endif
#ifndef Blt_FirstChild
#define Blt_FirstChild \
	(bltTkIntProcsPtr->blt_FirstChild) /* 17 */
#endif
#ifndef Blt_NextChild
#define Blt_NextChild \
	(bltTkIntProcsPtr->blt_NextChild) /* 18 */
#endif
#ifndef Blt_RelinkWindow
#define Blt_RelinkWindow \
	(bltTkIntProcsPtr->blt_RelinkWindow) /* 19 */
#endif
#ifndef Blt_Toplevel
#define Blt_Toplevel \
	(bltTkIntProcsPtr->blt_Toplevel) /* 20 */
#endif
#ifndef Blt_GetPixels
#define Blt_GetPixels \
	(bltTkIntProcsPtr->blt_GetPixels) /* 21 */
#endif
#ifndef Blt_GetXY
#define Blt_GetXY \
...
#define Blt_GetWindowExtents \
	(bltTkIntProcsPtr->blt_GetWindowExtents) /* 42 */
#endif
...
#define Blt_ParseTifTags \
	(bltTkIntProcsPtr->blt_ParseTifTags) /* 57 */
#endif
#ifndef Blt_GetFont
#define Blt_GetFont \
...
#define Blt_NewStripesBrush \
	(bltTkIntProcsPtr->blt_NewStripesBrush) /* 68 */
#endif
#ifndef Blt_NewCheckersBrush
#define Blt_NewCheckersBrush \
	(bltTkIntProcsPtr->blt_NewCheckersBrush) /* 69 */
#endif
...
#define Blt_GetBrushTypeName \
	(bltTkIntProcsPtr->blt_GetBrushTypeName) /* 73 */
#endif
...
#define Blt_GetBrushColorName \
	(bltTkIntProcsPtr->blt_GetBrushColorName) /* 75 */
#endif
#ifndef Blt_GetBrushPixel
#define Blt_GetBrushPixel \
	(bltTkIntProcsPtr->blt_GetBrushPixel) /* 76 */
#endif
...
#define Blt_GetXColorFromBrush \
	(bltTkIntProcsPtr->blt_GetXColorFromBrush) /* 78 */
#endif
...
#define Blt_SetBrushArea \
	(bltTkIntProcsPtr->blt_SetBrushArea) /* 91 */
#endif
...
#define Blt_IsHorizontalLinearBrush \
	(bltTkIntProcsPtr->blt_IsHorizontalLinearBrush) /* 96 */
#endif
...
#define Blt_Image_GetMasterData \
	(bltTkIntProcsPtr->blt_Image_GetMasterData) /* 153 */
#endif
